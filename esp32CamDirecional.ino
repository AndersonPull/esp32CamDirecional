...
void startCameraServer(){
  ...
  if (httpd_start(&stream_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(stream_httpd, &up_uri);
    httpd_register_uri_handler(stream_httpd, &down_uri);
    httpd_register_uri_handler(stream_httpd, &front_uri);
...
static esp_err_t up(httpd_req_t *req){
  Serial.println("Subindo");
  return true;
}

static esp_err_t down(httpd_req_t *req){
  Serial.println("descendo");
  return true;
}

static esp_err_t front(httpd_req_t *req){
  Serial.println("indo para frente");
  return true;
}

static esp_err_t back(httpd_req_t *req){
